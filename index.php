...
if ($queryCount >= $queryLimit) {
    echo "Sorgu limiti aşıldı. Daha fazla sorgu yapılamaz.";
    exit;
}

// URL'den intelx_id parametresini al
if (!isset($_GET['intelx_id'])) {
    echo "intelx_id parametresi belirtilmemiş.";
    exit;
}
...
if ($response) {
    echo "Intelx ID: $intelxId sorgulandı.\n";
    ...
    echo "Intelx ID: $intelxId sorgulanamadı.\n";
}
